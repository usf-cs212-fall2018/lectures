...
public class ExceptionDemo {
	 ...
	 * versus the total points possible. Note that this method does not explicitly
	 * throw any exceptions, but an {@link ArithmeticException} will be thrown if
	 * the value of possible is 0.
	 *
	 * @param total points earned
	 * @param possible points
	 * @return percentage
	 */
	 ...
	 * clutters the code quite a bit, making it harder to follow. Also, notice we
	 * have a problem if we return too soon without closing the Scanner object.
	 */
	 ...
	 * uncaught demo, and always makes sure the Scanner is closed. However, we are
	 * not catching cases with negative values and the output is not
	 * user-friendly!
	 */
	 ...
	 * Scanner object removes the necessity of the finally block. We added back in
	 * a little bit of validation where necessary, and made the catch blocks more
	 * specific to give better output to the user.
	 */
