...
public class MapDemo {
	 ...
	 *
	 * @param map  - where to store word count
	 * @param text - test case to use
	 */
	private static void demoMap(Map<String, Integer> map, String text) {
		...
		for (String word : text.split(" ")) {
			...
			/*
			 * Or, we can take advantage of the convinence methods in the map class
		...
		// We can use Java 10 and an entrySet instead:
	...
	public static void main(String[] args) {
		...
		/*
		 * Notice that the same code works whether you use a HashMap or a TreeMap as
		 * the implementation. The only visible difference is the output order.
		 */
