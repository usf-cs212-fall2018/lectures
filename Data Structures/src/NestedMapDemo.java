...
public class NestedMapDemo {
	 ...
	 * example, the word "ant" has 3 characters. The word "bat" also has length 3.
	 * So both words should appear in the set for words of length 3.
	 */
	public static void main(String[] args) {
		...
		for (String word : text.toLowerCase().split(" ")) {
			...
			words.putIfAbsent(length, new HashSet<>());
			...
			/*
			 * This can be confusing. We are getting the set stored WITHIN the map,
			 * and adding a word directly. We do not need to call put() again. This is
			 * related to mutability and references in Java which we will get into
			 * more detail later.
			 */
		}
