...
public class GenericsDemo {
	...
	public static void listDemo() {
		/*
		 * Instead of raw types, use the Generics notation to specify what type of
		 * object this ArrayList should store.
		 *
		 * You can initialize as follows: ArrayList<String> list = new
		 * ArrayList<String>();
		 *
