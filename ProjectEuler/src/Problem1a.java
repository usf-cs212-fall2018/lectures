...
public class Problem1a {
	 ...
	 * only. Any changes required modification to the original source code, and
	 * then recompiling that source code. Sure, Eclipse makes recompiling seem
	 * easy but it will be beyond what most users are willing to do (even
	 * developers).
	 *
