...
public class PrefixDemo {
	...
	public static void main(String[] args) {
		...
		String[] words = { "ant", "antelope", "ape", "bat", "badger", "cat",
				"catfish", "dog", "dragonfly" };
		...
		/*
		 * Even though we cannot access the "internal" data structure directly, we
		 * can access it through the returned reference and run amok with the data.
		 */
		 ...
		 * structure. We can no longer guarantee that the map stores prefixes and
		 * strings that start with that prefix.
		 */
		...
		/*
		 * But with nested data structures, we still have issues with the nested
		 * data structures.
		 */
