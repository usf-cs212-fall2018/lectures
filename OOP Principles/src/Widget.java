...
public class Widget {
	 ...
	 * Should initialize at declaration.
	 *
	 ...
	 * object, this means the reference cannot be updated (but the mutable object
	 * remains mutable). More later.
	 *
	 ...
	 * ArrayList class specific to String objects, and another specific to Integer
	 * objects, and so on.) We specify the type with the <> generics notation.
	 * Generics are a form of polymorphism ("many forms").
	 */
	...
	public Widget(String name) {
		...
		if (debug) {
			System.out.println(
					"Created widget #" + widgetID + " named " + widgetName + "."
					);
		}
	}
	 ...
	 *
	 * DEFAULT CONSTRUCTOR - A constructor that takes no parameters. It is usually
