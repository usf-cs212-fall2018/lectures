...
public class HashCodeDemo {
	...
	/**
	 * Shows the actual hash codes and the String representation of the specified
	 * object.
	 *
	 ...
	 * implementation, which is a unique identifier for that object. While not
	 * necessary, this is often a reference to the memory address of where the
	 * object is currently stored. Most classes override this implementation.
	 *
	 * It is not the focus of this example!
	 *
	 * @param label  - label to use in output
	 ...
	 * @param label  - label to use in output
	 * @param object - object array to display
	 */
	public static void printHash(String label, Object[] object) {
	...
	/**
	 * Used to demonstrate how the memory location is or is not modified within a
	 * method call for this type of object.
	 *
	 * @param value - value passed in from main method
	 */
	...
	public static void main(String[] args) {
		 ...
		 *
		 * When changing the value of an immutable object, you are actually creating
		 * a new object. The reference to the old object is broken and updated to
		 * the new object. The garbage collector will clean up the now unused space
		 * of the old object.
		 *
		 * Notice how the memory address changes once the Integer value is modified
		 ...
		 * location. This allows Java to optimize its memory usage. That is also why
		 * you should avoid calling "new" when it comes to immutable objects.
		 */
		...
		/*
		 * Because of this, if you need to make a lot of modification to a String,
		 * use a StringBuilder instead (or a StringBuffer if you are using multiple
		 * threads).
		 *
		...
		/*
		 * Arrays are mutable objects in Java. (You see the "new" keyword after all,
		 * don't you?)
		 */
		 ...
		 * objects are mutable, so passing a reference can be dangerous. A function
		 * could clear the collection completely through the reference.
		 */
