...
public class RandomArrayTotal {
	 ...
	 */
	public static long total(int[] numbers, int threads)
			throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	private static void benchmark(int size, int threads)
			throws InterruptedException {
		int warmup = 10;
		int runs = 30;
		...
		System.out.printf(
				"%.05f seconds average for %d numbers and %d threads%n",
				average, size, threads
		);
	}
}
