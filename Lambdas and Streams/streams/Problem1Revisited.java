...
public class Problem1Revisited {
	...
	public static void main(String[] args) {
		...
		System.out.println(sumMultiples(max, new int[] { 3, 5 }));
	}
	...
	public static int sumMultiples(int max, int[] multiples) {
		// create one predicate for multiples traditionally
//		IntPredicate predicate = multiples.length < 1 ? num -> true : num -> num % multiples[0] == 0;
//
//		for (int i = 1; i < multiples.length; i++) {
//			predicate = predicate.or(num -> num % multiples[1] == 0);
//		}
